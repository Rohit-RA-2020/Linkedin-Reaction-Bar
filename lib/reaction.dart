...
class ReactionState extends State<Reaction> with TickerProviderStateMixin {
  ...
  Animation moveLeftIconLikeWhenRelease,
      moveLeftIconCelebrateWhenRelease,
      moveLeftIconSupportWhenRelease,
      moveLeftIconLoveWhenRelease,
      moveLeftIconInsightWhenRelease,
      moveLeftIconCuriousWhenRelease;
  ...
  // 0 = nothing, 1 = like, 2 = celebrate, 3 = support, 4 = love, 5 = Insightful, 6 = Curious
  ...
  initAnimationBoxAndIcons() {
    ...
    pushIconCelebrateUp = Tween(begin: 30.0, end: 60.0).animate(
      CurvedAnimation(parent: animControlBox, curve: Interval(0.1, 0.6)),
    );
    zoomIconCelebrate = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: animControlBox, curve: Interval(0.1, 0.6)),
    );
    ...
    pushIconInsightUp = Tween(begin: 30.0, end: 60.0).animate(
      CurvedAnimation(parent: animControlBox, curve: Interval(0.4, 0.9)),
    );
    zoomIconInsight = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: animControlBox, curve: Interval(0.4, 0.9)),
    );

    pushIconCuriousUp = Tween(begin: 30.0, end: 60.0).animate(
      CurvedAnimation(parent: animControlBox, curve: Interval(0.5, 1.0)),
    );
    zoomIconCurious = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: animControlBox, curve: Interval(0.5, 1.0)),
    );
    ...
    pushIconCelebrateUp.addListener(() {
      setState(() {});
    });
    zoomIconCelebrate.addListener(() {
      setState(() {});
    });
    ...
    pushIconInsightUp.addListener(() {
      setState(() {});
    });
    zoomIconInsight.addListener(() {
      setState(() {});
    });
    pushIconCuriousUp.addListener(() {
      setState(() {});
    });
    zoomIconCurious.addListener(() {
      setState(() {});
    });
  }
  ...
  initAnimationIconWhenRelease() {
    ...
    moveLeftIconLikeWhenRelease = Tween(begin: 20.0, end: 10.0).animate(
        CurvedAnimation(
            parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconCelebrateWhenRelease = Tween(begin: 68.0, end: 10.0).animate(
        CurvedAnimation(
            parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconSupportWhenRelease = Tween(begin: 116.0, end: 10.0).animate(
        CurvedAnimation(
            parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconLoveWhenRelease = Tween(begin: 164.0, end: 10.0).animate(
        CurvedAnimation(
            parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconInsightWhenRelease = Tween(begin: 212.0, end: 10.0).animate(
        CurvedAnimation(
            parent: animControlIconWhenRelease, curve: Curves.decelerate));
    moveLeftIconCuriousWhenRelease = Tween(begin: 260.0, end: 10.0).animate(
        CurvedAnimation(
            parent: animControlIconWhenRelease, curve: Curves.decelerate));
    ...
    moveLeftIconCelebrateWhenRelease.addListener(() {
      setState(() {});
    });
    ...
    moveLeftIconInsightWhenRelease.addListener(() {
      setState(() {});
    });
    moveLeftIconCuriousWhenRelease.addListener(() {
      setState(() {});
    });
  }
                ...
                whichIconUserChoose == 2 && !isDragging
                    ? Container(
                        ...
                        margin: EdgeInsets.only(
                          top: processTopPosition(
                              this.moveUpIconWhenRelease.value),
                          left: this.moveLeftIconCelebrateWhenRelease.value,
                        ),
                      )
                    : Container(),
                ...
                whichIconUserChoose == 5 && !isDragging
                    ? Container(
                        ...
                        margin: EdgeInsets.only(
                          top: processTopPosition(
                              this.moveUpIconWhenRelease.value),
                          left: this.moveLeftIconInsightWhenRelease.value,
                        ),
                      )
                    : Container(),
                ...
                whichIconUserChoose == 6 && !isDragging
                    ? Container(
                        ...
                        margin: EdgeInsets.only(
                          top: processTopPosition(
                              this.moveUpIconWhenRelease.value),
                          left: this.moveLeftIconCuriousWhenRelease.value,
                        ),
                      )
                    : Container(),
              ],
        ...
        children: <Widget>[
          ...
          Transform.scale(
            child: Container(
              ...
              margin: EdgeInsets.only(bottom: pushIconCelebrateUp.value),
              width: 50.0,
          ...
          Transform.scale(
            child: Container(
              ...
              margin: EdgeInsets.only(bottom: pushIconInsightUp.value),
              width: 50.0,
          ...
          Transform.scale(
            child: Container(
              ...
              margin: EdgeInsets.only(bottom: pushIconCuriousUp.value),
              width: 50.0,
    ...
    if (!isLongPress && isLiked) {
      ...
      switch (whichIconUserChoose) {
        case 1:
          return 'images/ic_like_fill.png';
        case 2:
          return 'images/celebrate.png';
        case 3:
          return 'images/support.png';
        case 4:
          return 'images/love.png';
        case 5:
          return 'images/insight.png';
        case 6:
          return 'images/curious.png';
        default:
